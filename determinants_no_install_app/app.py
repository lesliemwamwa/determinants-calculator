...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        try:
            ...
            self.send_html(result_page(matrix, det))

        except Exception as e:
            self.send_html(home(str(e)))

if __name__ == "__main__":
    print("Starting Determinants Calculator...")
